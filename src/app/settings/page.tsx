                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
                    ...
                    <div className="md:col-span-3 space-y-2">
                        {[
                            ...
                            { label: 'Telemetry', icon: Bell },
                            { label: 'Filters', icon: Filter },
                            { label: 'Security', icon: Shield },
                        ].map((item, i) => (
                            <button key={i} className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-bold transition-all ${item.active ? 'bg-primary/10 text-primary border border-primary/20' : 'text-muted-foreground hover:bg-secondary'}`}>
                    ...
                    <div className="md:col-span-9 space-y-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-3">
                                <div className="pro-card p-4 flex items-center justify-between hover:bg-secondary/30 transition-colors">
                                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-8 p-8 pro-card">
