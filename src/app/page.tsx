        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            {[
              ...
              <div key={i} className="pro-card p-5 group hover:border-primary/50 transition-all cursor-default">
              ...
              <div className="grid gap-5">
                {filteredJobs.map((job, i) => (
                  <motion.div
                    ...
                    className="pro-card p-6 group pro-card-hover relative bg-card overflow-hidden"
                  >
                    {/* Score Indicator */}
